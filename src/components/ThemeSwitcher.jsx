...
const ThemeSwitcher = () => {
  ...
  return (
    <div className="theme-wrapper bg-custom-black flex h-8 w-14 items-center justify-around rounded-full">
      <button
        className={`${activeThemeCircle} ${
      ...
      <button
        className={`${activeThemeCircle} ${theme === "dark" ? "bg-white" : ""}`}
